...
#        return output
#
##class OFSwitch(Device):
##    """Class that represent a OpenFlow Siwtch as a node.
##
##    [better document here.]
##    """
##    def __init__(self, ports, alias, dpid, connection, description):
##        self.dpid = dpid
##        self.connection = connection
##        self.description = description
##        super().__init__(DeviceType.SWITCH, ports, alias)
##
##    @property
##    def dtype(self):
...
#    """
#
#    def __init__(self, dtype=DeviceType.SWITCH, ports=None,
...
#        #: user defined alias
#        self.alias = alias
#        #: Switch properties dict, such as SB Protocol, dpid, etc.
#        self.properties = properties or {}
#
#    @property
#    def id_(self):
